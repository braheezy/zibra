...
const wpt_fixtures = [_]WptFixture{
    ...
    .{
        ...
        .status = "PASS",
        .timeout_ms = 10_000,
        .output_basename = "wpt-css-nested-sizing.jsonl",
    },
    .{
    ...
    .{
        ...
        .status = "PASS",
        .timeout_ms = 10_000,
        .output_basename = "wpt-html-fragments.jsonl",
    },
    .{
        .fixture = "tests/manual/document-accessors.html",
        .status = "PASS",
        .timeout_ms = 10_000,
        .output_basename = "wpt-document-accessors.jsonl",
    },
    .{
    ...
    .{
        ...
        .status = "PASS",
        .timeout_ms = 10_000,
        .output_basename = "wpt-js-box-metrics.jsonl",
    },
    .{
