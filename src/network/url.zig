...
pub const Url = struct {
    ...
    pub fn fetchBodyWithSourceContextSynchronized(
        ...
        return transport.fetchBodyInternal(Url, inheritFragment, allocator, io, client, jar, cache, lock, url, referrer, cookie_source, null, null, null, policy, null);
    }
    ...
    pub fn fetchBodyLimitedSynchronized(
        ...
        return transport.fetchBodyInternal(Url, inheritFragment, allocator, io, client, jar, null, lock, url, referrer, referrer, null, null, null, referrer_policy, options);
    }
