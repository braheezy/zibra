...
/// Parse a tag/class/ID/`:focus-visible` selector, `:has(...)` relational
/// selector, or a whitespace-separated descendant selector. Attribute and
/// other combinator selectors are not yet supported.
