...
pub const shorthands = [_]Shorthand{
    ...
    .{ .name = "background", .longhands = &.{ "background-color", "background-image", "background-size", "background-repeat", "background-position", "background-attachment", "background-origin" } },
...
pub const computed = svgProperties() ++ [_]Property{
    ...
    .{ .name = "overflow-x", .default_value = "visible" },
    .{ .name = "overflow-y", .default_value = "visible" },
    ...
    .{ .name = "background-origin", .default_value = "padding-box" },
    ...
    .{ .name = "grid-auto-flow", .default_value = "row" },
    .{ .name = "grid-row-start", .default_value = "auto" },
    .{ .name = "grid-row-end", .default_value = "auto" },
    .{ .name = "grid-column-start", .default_value = "auto" },
    .{ .name = "grid-column-end", .default_value = "auto" },
