...
At the previous progress snapshot, the portable aggregate—now run with
...
`test-wpt-runner` cases. The current runner tests also cover reftest capture
and comparison through `test-wpt-runner`.
